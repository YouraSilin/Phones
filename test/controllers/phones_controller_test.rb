...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference("Phone.count") do
      post phones_url, params: { phone: { department: @phone.department, email: @phone.email, mobile: @phone.mobile, name: @phone.name, number: @phone.number, position: @phone.position } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { department: @phone.department, email: @phone.email, mobile: @phone.mobile, name: @phone.name, number: @phone.number, position: @phone.position } }
